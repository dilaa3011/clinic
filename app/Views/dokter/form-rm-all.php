                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if (isset($resepPerRM[$rekam['pasien_id']])): ?>
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                        <?php foreach ($resepPerRM[$rekam['pasien_id']] as $resep): ?>
                                                                            <tr>
                                                                                <td><?= esc($resep['nama_obat']) ?></td>
                                                                                <td><?= esc($resep['dosis']) ?></td>
                                                                                <td><?= esc($resep['aturan_pakai']) ?></td>
                                                                                <td><?= esc($resep['tanggal_resep']) ?></td>
                                                                            </tr>
                                                                        <?php endforeach; ?>
                                                                    </tbody>
                                                                </table>
                                                            <?php else: ?>
                                                                <p class="text-muted">Tidak ada resep untuk pasien ini.</p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>

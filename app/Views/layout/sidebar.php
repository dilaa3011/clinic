                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="dashboard">
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="<?= base_url('/master-agama'); ?>" a>
                                    <span class="sub-item">Data Agama</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?= base_url('/master-gender'); ?>">
                                    <span class="sub-item">Data Jenis Kelamin</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('/master-penyakit'); ?>">
                                    <span class="sub-item">Data Penyakit</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('/master-tindakan'); ?>">
                                    <span class="sub-item">Data Tindakan</span>
                                </a>
                            </li>
                            <li>
